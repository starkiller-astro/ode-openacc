...
module rates_module
  ...
  real (kind=dp_t), parameter :: f17_to_o17 = exp(-4.53302d0)
  real (kind=dp_t), parameter :: ne18_to_f18 = exp(-0.880534d0)
...
contains
  ...
  subroutine rate_he4_ne18_to_p_na21(tfactors,rate)
    ...
    real (kind=dp_t) :: r0, r1, r2, r3, r4, r5, r6
  ...
  subroutine rate_he4_o14_to_p_f17(tfactors,rate)
    ...
    real (kind=dp_t) :: r0, r1, r2, r3, r4, r5
